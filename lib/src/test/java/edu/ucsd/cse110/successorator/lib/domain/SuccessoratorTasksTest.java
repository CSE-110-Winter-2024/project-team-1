...
public class SuccessoratorTasksTest {
    ...
    public void testUntoggle() {
        ...
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Normal, 0, TaskContext.Home));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Normal, 0, TaskContext.Home));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, true, TaskType.Normal, 0, TaskContext.Home));
    ...
    public void testRescheduleTwice() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Recurring, LocalDate.now().toEpochDay(), TaskContext.Home));
        tasks.add(new SuccessoratorTask(1, "Task 2", 1, false, TaskType.Recurring, LocalDate.now().toEpochDay(), TaskContext.Home));
        tasks.add(new SuccessoratorTask(1, "Task 3", 2, false, TaskType.Recurring, 0, TaskContext.Home));
        tasks.add(new SuccessoratorTask(1, "Task 4", 3, false, TaskType.Recurring, 0, TaskContext.Home));
