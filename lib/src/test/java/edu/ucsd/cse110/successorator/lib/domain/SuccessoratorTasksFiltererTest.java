...
public class SuccessoratorTasksFiltererTest {
    ...
    public void testFilterTomorrow() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Normal, LocalDate.now().plusDays(1).toEpochDay(), LocalDate.now().plusDays(1).toEpochDay(), TaskInterval.Daily));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Normal, LocalDate.now().toEpochDay(), LocalDate.now().toEpochDay(), TaskInterval.Daily));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, false, TaskType.Normal, 0, 0, TaskInterval.Daily));
    ...
    public void testFilterRecurring() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Recurring, 0, 0, TaskInterval.Daily));
