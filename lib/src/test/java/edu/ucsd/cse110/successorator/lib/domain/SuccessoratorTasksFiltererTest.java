...
public class SuccessoratorTasksFiltererTest {
    ...
    public void testFilterToday() {
        ...
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Normal, LocalDate.now().toEpochDay()));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Normal, 0));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, false, TaskType.Normal, 0));
    ...
    public void testFilterTomorrow() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Normal, LocalDate.now().plusDays(1).toEpochDay()));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Normal, LocalDate.now().toEpochDay()));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, false, TaskType.Normal, 0));
    ...
    public void testFilterRecurring() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Recurring, 0));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Pending, 0));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, false, TaskType.Normal, 0));
    ...
    public void testFilterPending() {
        List<SuccessoratorTask> tasks = new ArrayList<>();
        tasks.add(new SuccessoratorTask(1, "Task 1", 0, false, TaskType.Normal, 0));
        tasks.add(new SuccessoratorTask(2, "Task 2", 1, false, TaskType.Pending, 0));
        tasks.add(new SuccessoratorTask(3, "Task 3", 2, false, TaskType.Normal, 0));
