...
public class SuccessoratorTask {
    ...
    public SuccessoratorTask(@Nullable Integer id, @NonNull String name, int sortOrder, @NonNull Boolean isComplete, @NonNull TaskType type, @NonNull long dueDate, TaskInterval interval) {
        this.name = name;
    ...
    public SuccessoratorTask withId(int id) {
        return new SuccessoratorTask(id, name, sortOrder, isComplete, type, dueDate, interval);
    }
